...
- (IBAction)onChange:(id)sender {
    ...
    NSArray *items = @[@"mutiMatte",@"matteBitmap",@"Rocket",@"heartbeat",@"audio_biling",@"audio_biling",@"c",@"matteBitmap_1.x",@"rose_2.0.0",@"matteRect",@"rose_1.5.0"];
    
    [parser parseWithNamed:items[arc4random() % items.count] inBundle:nil completionBlock:^(SVGAVideoEntity * _Nonnull videoItem) {
        if (videoItem != nil) {
